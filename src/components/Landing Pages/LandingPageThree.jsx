...
function LandingPageThree() {
	return(
		<div className="LandingPageOneContainer grid h-screen place-items-center min-h-screen bg-gradient-to-r from-blue-900 to-blue-600">
			<div className='rounded-sm border-4 border-slate-100 p-3 bg-slate-600/40'>
				<h1 className='text-slate-100 text-6xl font-bold font-mono'>
					STUFFWARE WAREHOUSE
				</h1>
			</div>
			<div className='rounded-sm border-4 border-slate-100 w-3/5 p-10 text-2xl text-slate-100 font-bold font-mono bg-slate-600/40'>
				<h4>
			...
			<div className='rounded-sm border-4 border-slate-100 w-3/5 p-5 text-2xl text-slate-100 font-bold font-mono bg-slate-600/40'>
